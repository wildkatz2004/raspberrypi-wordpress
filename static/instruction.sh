...
|                                                                       |
|This WordPress appliance comes with PHP 7.3, NGINX and Redis Cache for |
...
|                                                                       |
|Complete instructions can be found here: https://bit.ly/2E5fbUn        |
|                                                                       |
|If you have any questions please email me: duane.britting@gamil.com    |
+-----------------------------------------------------------------------+
